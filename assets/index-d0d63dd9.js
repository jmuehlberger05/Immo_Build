...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:_n,depthTest:!1,depthWrite:!1})}function Wa(){return new Fn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ir(),fragmentShader:`
		...
		`,blending:_n,depthTest:!1,depthWrite:!1})}function Xa(){return new Fn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ir(),fragmentShader:`
